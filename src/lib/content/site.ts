...
export const beliefStatements = [
  ...
  },
  {
    title: "Jesus Christ",
    preview:
      "Jesus Christ is God the Son, fully God and fully man, and will return in power and glory.",
    statement:
  ...
  },
  {
    title: "Holy Spirit",
    preview:
      "The Holy Spirit is co-equal with the Father and Son and empowers Spirit-led living.",
    statement:
  ...
  },
  {
    title: "Virgin Birth",
    preview:
      "Jesus Christ was conceived by God the Father through the Holy Spirit in the virgin Mary's womb.",
    statement:
  ...
  },
  {
    title: "Repentance",
    preview:
      "Repentance is the commitment to turn away from sin and follow Christ.",
    statement:
  ...
  },
  {
    title: "Jesus' Blood",
    preview:
      "The blood Jesus Christ shed on the cross is sufficient to cleanse mankind of all sin.",
    statement:
  ...
  },
  {
    ...
    preview:
      "Christians invite Jesus to live inside them by His Holy Spirit and trust His finished work.",
    statement:
  ...
  },
  {
    ...
    preview:
      "The promise of the Father empowers the Church to preach the Gospel throughout the earth.",
    statement:
  ...
  },
  {
    ...
    preview:
      "The Holy Spirit gives spiritual gifts to build and sanctify the church.",
    statement:
  ...
  },
  {
    title: "The Church",
    preview:
      "The church is the worldwide body of Christ, and believers are called into a local church family.",
    statement:
  ...
  },
  {
    title: "Eternity",
    preview:
      "People were created to exist forever, either separated from God or with God through salvation.",
    statement:
  ...
  },
  {
    title: "Second Coming",
    preview:
      "Jesus Christ will physically and visibly return to earth to establish His Kingdom.",
    statement:
